...
public class SavedArticleListFragment extends BaseListFragment implements ArticlesAdapter.OnItemClickListener,
    PopupMenu.OnMenuItemClickListener{
    private NewsActivityViewModel mViewModel;
    @Inject
    public ViewModelsFactory viewModelsFactory;
    private ArticlesAdapter adapter;
    @BindView(R.id.rv_saved_articles_list) public RecyclerView recyclerView;
    ...
    public static BaseListFragment newInstance(String arg) {
        ...
        SavedArticleListFragment newsFragment = new SavedArticleListFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_saved_article_list,
                container, false);
    ...
    public void onStart() {
        ...
        articlesStream = mViewModel.getSavedArticlesStream();
